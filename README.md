# COMP3480 Cloud Computing

Welcome to the experiments of my Cloud Computing class, each folder has what is necessary to explain individual project.

## Labs

- [Lab 1: FastAPI Server with Python 3.9](https://github.com/adomaitisc/COMP3480/tree/main/lab1)
- [Lab 2: FastAPI Server with a Python 3.9 CLI and Route Tests](https://github.com/adomaitisc/COMP3480/tree/main/lab2)
...
- [Load Balancer with Nginx: Docker Compose to orchestrate many FastAPI apps](https://github.com/adomaitisc/COMP3480/tree/main/load-balancer)
